        ...
        <v-card class="px-4 py-1">
            <v-row>
                <v-col class="d-flex align-center">
                    <b class="mr-2">Код товара:</b> {{ product.product_code }}
                </v-col>
                <v-col class="d-flex align-center">
                    <b class="mr-2">Цена закупки:</b> {{ product.price }}
                </v-col>
                <v-col class="d-flex align-center">
...
export default {
    ...
    methods: {
        ...
        save(){
            axios.put(`/api/products/update/${this.$route.params.id}`, this.product).then(res=>{
